    ...
    return (
        <div className="categorias-page">
            <div className="page-header">
                ...
                <button className="btn-cyan" onClick={() => alert('Abrir modal para agregar nueva categoría')}>
                    <span>+</span> Agregar
                </button>
            </div>
                                ...
                                <td>
                                    <div className="actions-cell">
                                        ...
                                        <button
                                            ...
                                            title="Detalle"
                                            onClick={() => alert(`Ver detalles de: ${cat.name}`)}
                                        >
                                        ...
                                        <button
                                            ...
                                            title="Eliminar"
                                            onClick={() => alert(`¿Eliminar categoría: ${cat.name}?`)}
                                        >
